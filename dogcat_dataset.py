"""
A Pylearn2 Dataset class for accessing the data for Dog and Cat Classification
"""
__authors__ = "Ian Goodfello"
...
class DogCatDataset(DenseDesignMatrix):
    """
    ...
    def __init__(self, which_set,
        ...
        super(DogCatDataset, self).__init__(X=X, y=y, view_converter=view_converter)
    ...
    def _load_data(self, path, expect_labels):
        ...
        if expect_labels:
            y = np.asarray(y_list).astype('uint8')
